= SM_8mosind Library for Arduino =
...
For more information about this library please visit the https://github.com/SequentMicrosystems/8mosind-arduino/blob/main/README.md
